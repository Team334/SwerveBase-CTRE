...
- At the start of the 2026 season this project should be re-imported in the 2026 wpilib release for any additional updates.
- After that, since this project is a template on github, the actual 2026 robot code repo can be generated from this template:
