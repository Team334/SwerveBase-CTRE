...
//     tags.add(
//         new AprilTag(1, new Pose3d(1, 0, 1.2, new Rotation3d(0, -0.3, -Math.PI)))); // close tag
// #1
//     tags.add(
//         new AprilTag(
...
//     tags.add(
//         new AprilTag(4, new Pose3d(7, 0.8, 0.8, new Rotation3d(-0.5, -1, -Math.PI)))); // far tag
// #2
//     tags.add(
...
//             new double[] {
//               4, 3, 5
//             }, // these are worse std devs, so it should come before the better estimate @
// timestamp
//             // = 2s
//             true));
